...
Write-Host "Starting Services for $tenant."
...
foreach ($displayName in $displayNames){
    Write-Host "Starting $displayName on"$($env:computername)
    Start-Service -DisplayName $displayName -ErrorAction SilentlyContinue
}
}
}
